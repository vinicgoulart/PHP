        ...
        <div class="content mt-3">
            <div class="col-sm-12">
                <div class="card-body card-block">
                    <form action="updating_books.php?codlivro=<?php echo $codlivro;?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="titulo" value=
                                "
                                    <?php 
                                    echo $linha['titulo'];
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="auto" name="autor" value=
                                "
                                    <?php 
                                    echo $linha['autor'];
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="editora" name="editora" value=
                                "
                                    <?php 
                                    echo $linha['editora'];
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="editora" class=" form-control-label">Quantidade de Exemplares</label>
                            </div>
                            <div class="col-12 col-md-9">
                                <input type="number" id="editora" name="qntd" value=
                                "
                                    <?php 
                                    echo $linha['qtdeExemplares'];
