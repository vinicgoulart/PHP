        ...
        <div class="content mt-3">
            <div class="col-sm-12">
                <div class="card-body card-block">
                    <form action="insert-books.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="number" id="editora" name="qntd" placeholder="Número Exemplares" class="form-control">
                            </div>
                        </div>
